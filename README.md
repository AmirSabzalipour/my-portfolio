...
<span style="font-size: 15px; color: darkslategray; font-family: 'Avenir Next LT Pro', sans-serif;">Programming :</span> <span style="font-size:13px; color:black;  font-family: 'Avenir Next LT Pro', sans-serif;">Proficient in Python, C, Mathematica, and SQL (Structured Query Language).</span> 
