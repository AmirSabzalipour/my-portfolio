...
<span style="font-size:14px; color:cadetblue;">Programming :</span> <span style="font-size:13px;">Proficient in Python, C, Mathematica, and SQL (Structured Query Language).</span> 

<span style="font-size:14px; color:cadetblue;">Data Science :</span> <span style="font-size:13px;">Extensive experience in data science libraries such as NumPy, Pandas, Matplotlib, Spark, Seaborn, Cufflinks, and more.</span> 
...
<span style="font-size:14px; color:#7cafc2 ;">Ph.D. in Physics:</span> <span style="font-size:13px;">University of Antwerp, Belgium,March 2017 - October 2021</span> 
