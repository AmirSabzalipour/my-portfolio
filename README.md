...
<img src="https://github.com/AmirSabzalipour/Data_Science/blob/main/images/aboutme.gif" alt="icon" width="40"> <!-- Replace "icon_url" with the URL of your icon and adjust the width as needed -->
