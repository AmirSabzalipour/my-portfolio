...
<span style="font-size: 16px; color: #C6DBE5; font-family: 'Avenir Next LT Pro'">Programming:</span> <span style="font-size:14px; color:C6DBE5;  font-family: 'Avenir Next LT Pro', sans-serif;">Proficient in Python, C, Mathematica, and SQL (Structured Query Language).</span> 
